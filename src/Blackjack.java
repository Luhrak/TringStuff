	...
	public static void main(String[] args) {
		...
		try (Scanner into = new Scanner(System.in)) {
			...
			while (!exit) {
				...
				boolean over = false;
				int[] c = new int[5]; // dis a new int array with 5 "slots"
				int[] a = new int[5];
...
/*
 * Array for player cards & for Ai cards 
 * function to draw a card > every time called gets counted up starting with 0
 * changes the int at the postion of that counting number in the array 
 */
